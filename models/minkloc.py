...
class MinkLoc(torch.nn.Module):
    def __init__(self, model, in_channels, feature_size, output_dim, planes, layers, num_top_down, conv0_kernel_size, use_unet = False ,fix_frontbone = False):
        super().__init__()
        self.model = model
        ...
        self.fix_frontbone = fix_frontbone
        self.use_unet = use_unet
        self.frontend = ResUNetBN2C(1, 32, 0.05, conv1_kernel_size=5, normalize_feature=True) if use_unet else None
