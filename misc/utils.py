...
class MinkLocParams:
    ...
    def __init__(self, params_path, model_params_path):
        ...
        self.use_unet = params.getboolean('use_unet', False)
        self.fix_frontbone = params.getboolean('fix_frontbone', False)
        self.frontbone_weight = params.get('frontbone_weight', "")
        ...
        self.eval_database_files = ['kitti_evaluation_database.pickle', 'sjtu_evaluation_database.pickle']

        self.eval_query_files = ['kitti_evaluation_query.pickle', 'sjtu_evaluation_query.pickle']
