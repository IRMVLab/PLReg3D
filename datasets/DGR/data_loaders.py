...
from datasets.DGR.threedmatch_loader import *
from datasets.DGR.kitti_loader import *

ALL_DATASETS = [
    ThreeDMatchPairDataset07, ThreeDMatchPairDataset05, ThreeDMatchPairDataset03,
    ThreeDMatchTrajectoryDataset, KITTIPairDataset, KITTINMPairDataset, SJTUNMPairDataset
]
